...
<style>
  ...
  <body>
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              ...
              <div class="carousel-caption text-left">
                ...
                <h2 class="wow fadeInRight" data-wow-delay="0.4s">IX JORNADAS DE POSTCOSECHA</h2>
                <h4 class="wow fadeInRight" data-wow-delay="0.6s">15 y 16 de octubre - Chile 2025</h4>
                <a href="#services" class="btn btn-lg btn-common btn-effect wow fadeInRight" data-wow-delay="0.9s">Conoce Más</a>
            ...
            <div class="carousel-item">
              ...
              <div class="carousel-caption text-center">
                <h3 class="wow fadeInDown" data-wow-delay="0.3s">Facultad de Agronomía y</h3>
                <h2 class="wow bounceIn" data-wow-delay="0.6s">Sistemas Naturales UC</h2> 
                <h4 class="wow fadeInUp" data-wow-delay="0.9s">Innovación y Tecnología en Manejo de Cosechas</h4>
                <a href="#features" class="btn btn-lg btn-common btn-effect wow fadeInUp" data-wow-delay="1.2s">Ver Programa</a>
              </div>
            </div>
            <div class="carousel-item">
              ...
              <div class="carousel-caption text-center">
                ...
                <h4 class="wow fadeInUp" data-wow-delay="0.6s">Con apoyo de importantes auspiciadores nacionales e internacionales</h4>
    ...
    <section id="services" class="section">
      <div class="container">
        <div class="section-header">          
          <h2 class="section-title">Las Jornadas</h2>
          <span>Información</span>
          <p class="section-subtitle">Evento de prestigio internacional en el área de postcosecha organizado por la Facultad de Agronomía y Sistemas Naturales UC</p>
        </div>
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="item-boxes services-item wow fadeInDown" data-wow-delay="0.2s">
              ...
              <p>Miércoles 15 y jueves 16 de octubre de 2025 en la Facultad de Agronomía y Sistemas Naturales UC, Santiago, Chile.</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="item-boxes services-item wow fadeInDown" data-wow-delay="0.4s">
              ...
              <p>Conferencias magistrales, talleres prácticos y demostraciones con los mejores especialistas en postcosecha a nivel mundial.</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="item-boxes services-item wow fadeInDown" data-wow-delay="0.6s">
              ...
              <p>Últimas tendencias en conservación, procesamiento y control de calidad de productos agrícolas frescos.</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="item-boxes services-item wow fadeInDown" data-wow-delay="0.8s">
              ...
              <h4>Networking</h4>
              <p>Oportunidades únicas de networking con profesionales, investigadores y empresarios del sector agroindustrial.</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="item-boxes services-item wow fadeInDown" data-wow-delay="1s">
              ...
              <h4>Certificación</h4>
              <p>Certificado de participación otorgado por la Pontificia Universidad Católica de Chile a todos los asistentes.</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="item-boxes services-item wow fadeInDown" data-wow-delay="1.2s">
              ...
              <p>Patrocinado por Frutas de Chile y Fedefruta, con apoyo de importantes auspiciadores nacionales e internacionales.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Services Section End -->
        ...
        <!-- Start About Section -->
    <section class="about-section section" style="background-image: url('{{ asset('assets/img/frutas-background.jpg') }}'); background-size: cover; background-position: center; position: relative;">
      <div class="overlay" style="background: rgba(3, 18, 46, 0.95); position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 1;"></div>
      <div class="container" style="position: relative; z-index: 2;">
        <div class="row align-items-center">
          <div class="col-lg-6 col-md-12 col-sm-12">
            <div class="about-content text-white" style="color: #FFFFFF !important;">
              <h2 class="wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="100ms" style="color: #FFFFFF !important; text-shadow: 3px 3px 6px rgba(0,0,0,1) !important; font-weight: bold !important;">Innovación en Postcosecha</h2>
              <p class="wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="300ms" style="font-size: 16px; line-height: 1.8; color: #FFFFFF !important; text-shadow: 2px 2px 4px rgba(0,0,0,1) !important; font-weight: 500 !important;">
              ...
              <p class="wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="500ms" style="font-size: 16px; line-height: 1.8; color: #FFFFFF !important; text-shadow: 2px 2px 4px rgba(0,0,0,1) !important; font-weight: 500 !important;">
              ...
              <a href="#contact" class="btn btn-common btn-effect wow fadeInLeft" data-wow-delay="700ms" style="margin-top: 20px;">¡Únete a las Jornadas!</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-center">
          <div class="col-xl-8 col-lg-9 col-md-10 col-sm-12">
            <div class="cta-trial text-center">
              ...
              <p>No te pierdas este evento de prestigio internacional. Inscríbete ahora y forma parte de la comunidad de profesionales más importante del sector postcosecha en Chile.</p>
    ...
    <section id="features" class="section">
      <div class="container">
        <div class="section-header">          
          ...
          <p class="section-subtitle">Las IX Jornadas de Postcosecha Chile 2025 te ofrecen oportunidades únicas de aprendizaje y networking.</p>
        </div>
        <div class="row">
          <!-- Start featured -->
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="featured-box">
              ...
              <div class="featured-content">
                ...
                <p>Conecta con expertos y profesionales de todo el mundo en el área de postcosecha y tecnología agroalimentaria.</p>
              </div>
            </div>
          </div>
          <!-- End featured -->
          ...
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="featured-box">
              ...
              <div class="featured-content">
                ...
                <p>Aplica los conocimientos adquiridos de inmediato en tu empresa o investigación para obtener resultados tangibles.</p>
              </div>
            </div>
          </div>
          <!-- End featured -->
          ...
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="featured-box">
              ...
              <div class="featured-content">
                ...
                <p>Respaldado por la Pontificia Universidad Católica de Chile, garantizando excelencia académica y científica.</p>
              </div>
            </div>
          </div>
          <!-- End featured -->
          ...
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="featured-box">
              ...
              <div class="featured-content">
                ...
                <p>Establece conexiones estratégicas con líderes de la industria, investigadores y tomadores de decisiones.</p>
              </div>
            </div>
          </div>
          <!-- End featured -->
    ...
    <!-- <section id="portfolios" class="section">
      <div class="container">
        ...
        <div id="portfolio" class="row">
          <div class="col-lg-4 col-md-6 col-sm-12 mix development print">
                ...
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="img/portfolio/img-1.jpg"><i class="lni lni-zoom-in item-icon"></i></a>
                      </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 mix design print">
            <div class="portfolio-item">
              <div class="shot-item">
                ...
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="img/portfolio/img-2.jpg"><i class="lni lni-zoom-in item-icon"></i></a>
                      </div>
                      <a href="#">View Project</a>
                    </div>
                  </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 mix development">
            <div class="portfolio-item">
              <div class="shot-item">
                ...
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="img/portfolio/img-3.jpg"><i class="lni lni-zoom-in item-icon"></i></a>
                      </div>
                      <a href="#">View Project</a>
                    </div>
                  </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 mix development design">
            <div class="portfolio-item">
              <div class="shot-item">
                ...
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="img/portfolio/img-4.jpg"><i class="lni lni-zoom-in item-icon"></i></a>
                      </div>
                      <a href="#">View Project</a>
                    </div>
                  </div>
              ...
              <div class="shot-item">
                ...
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="img/portfolio/img-5.jpg"><i class="lni lni-zoom-in item-icon"></i></a>
                      </div>
                      <a href="#">View Project</a>
                    </div>
                  </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 mix print design">
            <div class="portfolio-item">
              <div class="shot-item">
                ...
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="img/portfolio/img-6.jpg"><i class="lni lni-zoom-in item-icon"></i></a>
                      </div>
                      <a href="#">View Project</a>
                    </div>
                  </div>
    ...
    <div id="pricing" class="section pricing-section">
      <div class="container">
        <div class="section-header">          
          ...
          <span>Tarifas</span>
          <p class="section-subtitle">Elige la modalidad de inscripción que se ajuste a tu perfil profesional para las IX Jornadas de Postcosecha 2025.</p>
        </div>
        ...
        <div class="row justify-content-center mt-5">
          <div class="col-lg-8 col-md-10 col-sm-12">
            <div class="payment-info" style="background-color: var(--uc-gris-claro); padding: 30px; border-radius: 10px; border-left: 5px solid var(--uc-celeste);">
    ...
    <!-- inicio seccion de estadisticas del evento -->
    <!-- <div class="counters section" style="background-color: #f8f9fa; padding: 80px 0;">
      <div class="container">
        <div class="section-header text-center mb-5">          
          <h2 class="section-title" style="color: var(--uc-azul-oscuro);">Las Jornadas en Números</h2>
          <span style="color: var(--uc-celeste);">Estadísticas</span>
          <p class="section-subtitle" style="color: var(--uc-gris-oscuro);">Datos relevantes sobre la trayectoria y alcance de las Jornadas de Postcosecha</p>
        </div>
        <div class="row"> 
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="facts-item" style="text-align: center; padding: 30px 15px;"> 
              <div class="icon" style="font-size: 3rem; color: var(--uc-celeste); margin-bottom: 20px;">
                <i class="lni lni-calendar"></i>
              </div>                
              <div class="fact-count">
                <h3 style="color: var(--uc-azul-oscuro); font-size: 2.5rem; font-weight: bold; margin-bottom: 10px;"><span class="counter">9</span>ª</h3>
                <h4 style="color: var(--uc-gris-oscuro); font-size: 1.1rem; font-weight: 500;">Edición</h4>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="facts-item" style="text-align: center; padding: 30px 15px;">
              ...
              <div class="fact-count">
                <h3 style="color: var(--uc-azul-oscuro); font-size: 2.5rem; font-weight: bold; margin-bottom: 10px;"><span class="counter">500</span>+</h3>
                <h4 style="color: var(--uc-gris-oscuro); font-size: 1.1rem; font-weight: 500;">Participantes Esperados</h4>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="facts-item" style="text-align: center; padding: 30px 15px;">
              ...
              <div class="fact-count">
                <h3 style="color: var(--uc-azul-oscuro); font-size: 2.5rem; font-weight: bold; margin-bottom: 10px;"><span class="counter">15</span>+</h3>
                <h4 style="color: var(--uc-gris-oscuro); font-size: 1.1rem; font-weight: 500;">Países Representados</h4>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="facts-item" style="text-align: center; padding: 30px 15px;">
              ...
              <div class="fact-count">
                <h3 style="color: var(--uc-azul-oscuro); font-size: 2.5rem; font-weight: bold; margin-bottom: 10px;"><span class="counter">25</span>+</h3>
                <h4 style="color: var(--uc-gris-oscuro); font-size: 1.1rem; font-weight: 500;">Expertos Internacionales</h4>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- fin seccion de estadisticas del evento -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-6 col-lg-7 col-md-8 col-sm-12">            
            <div class="cta-text text-center text-md-left">
              <h5>Stil confused? Download a free lite version to get started!</h5>
            </div>
          </div>
          <div class="col-xl-6 col-lg-5 col-md-4 col-sm-12 text-center text-md-right">
    ...
    <section id="team" class="section">
      <div class="container">
        <div class="section-header">          
          ...
          <span>Expertos</span>
          <p class="section-subtitle">Reconocidos investigadores y académicos que garantizan la excelencia científica de las IX Jornadas de Postcosecha Chile 2025.</p>
        </div>
        <div class="row justify-content-md-start justify-content-center">
          ...
          <div class="col-lg-4 col-md-6 col-sm-10 mb-4">
            <div class="single-team" style="border: 3px solid var(--uc-celeste); border-radius: 10px; overflow: hidden;">
              <div style="background: linear-gradient(135deg, var(--uc-celeste), var(--uc-azul)); height: 150px; display: flex; align-items: center; justify-content: center;">
              ...
              <div class="team-details" style="padding: 25px 20px;">
                <div class="team-inner text-center">
                  <h4 class="team-title" style="color: var(--uc-azul-oscuro); font-size: 1.3rem; margin-bottom: 8px;">Bruno Defilippi</h4>
                  <p style="color: var(--uc-celeste); font-weight: bold; margin-bottom: 5px;">Presidente Comité Científico</p>
                  <p style="color: var(--uc-gris-oscuro); font-size: 0.9rem; line-height: 1.4;">Instituto de Investigaciones Agropecuarias</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-10 mb-4">
            <div class="single-team" style="border: 1px solid var(--uc-gris-claro); border-radius: 10px; overflow: hidden; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 25px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
              <div style="background: linear-gradient(135deg, var(--uc-azul), var(--uc-azul-oscuro)); height: 120px; display: flex; align-items: center; justify-content: center;">
                <i class="lni lni-user" style="font-size: 3rem; color: white;"></i>
              </div>
              <div class="team-details" style="padding: 20px 15px;">
                <div class="team-inner text-center">
                  <h4 class="team-title" style="color: var(--uc-azul-oscuro); font-size: 1.1rem; margin-bottom: 5px;">Víctor Escalona</h4>
          ...
          <div class="col-lg-4 col-md-6 col-sm-10 mb-4">
            <div class="single-team" style="border: 1px solid var(--uc-gris-claro); border-radius: 10px; overflow: hidden; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 25px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
              ...
              <div class="team-details" style="padding: 20px 15px;">
                <div class="team-inner text-center">
                  <h4 class="team-title" style="color: var(--uc-azul-oscuro); font-size: 1.1rem; margin-bottom: 5px;">Reinaldo Campos</h4>
                  <p style="color: var(--uc-gris-oscuro); font-size: 0.85rem; line-height: 1.3;">Universidad de Chile</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-10 mb-4">
            <div class="single-team" style="border: 1px solid var(--uc-gris-claro); border-radius: 10px; overflow: hidden; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 25px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
              ...
              <div class="team-details" style="padding: 20px 15px;">
                <div class="team-inner text-center">
                  <h4 class="team-title" style="color: var(--uc-azul-oscuro); font-size: 1.1rem; margin-bottom: 5px;">Claudia Fuentealba</h4>
                  <p style="color: var(--uc-gris-oscuro); font-size: 0.85rem; line-height: 1.3;">Pontificia Universidad Católica de Valparaíso</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-10 mb-4">
            <div class="single-team" style="border: 1px solid var(--uc-gris-claro); border-radius: 10px; overflow: hidden; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 25px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
              ...
              <div class="team-details" style="padding: 20px 15px;">
                <div class="team-inner text-center">
                  <h4 class="team-title" style="color: var(--uc-azul-oscuro); font-size: 1.1rem; margin-bottom: 5px;">Romina Pedreschi</h4>
                  <p style="color: var(--uc-gris-oscuro); font-size: 0.85rem; line-height: 1.3;">Pontificia Universidad Católica de Valparaíso</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-10 mb-4">
            <div class="single-team" style="border: 1px solid var(--uc-gris-claro); border-radius: 10px; overflow: hidden; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 25px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
              ...
              <div class="team-details" style="padding: 20px 15px;">
                <div class="team-inner text-center">
                  <h4 class="team-title" style="color: var(--uc-azul-oscuro); font-size: 1.1rem; margin-bottom: 5px;">Lida Fuentes</h4>
                  <p style="color: var(--uc-gris-oscuro); font-size: 0.85rem; line-height: 1.3;">Centro Regional de Estudios en Alimentos Saludables</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-10 mb-4">
            <div class="single-team" style="border: 1px solid var(--uc-gris-claro); border-radius: 10px; overflow: hidden; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 25px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
              ...
              <div class="team-details" style="padding: 20px 15px;">
                <div class="team-inner text-center">
                  <h4 class="team-title" style="color: var(--uc-azul-oscuro); font-size: 1.1rem; margin-bottom: 5px;">Pablo Ulloa</h4>
                  <p style="color: var(--uc-gris-oscuro); font-size: 0.85rem; line-height: 1.3;">Instituto de Investigaciones Agropecuarias</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-10 mb-4">
            <div class="single-team" style="border: 1px solid var(--uc-gris-claro); border-radius: 10px; overflow: hidden; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 25px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
              ...
              <div class="team-details" style="padding: 20px 15px;">
                <div class="team-inner text-center">
                  <h4 class="team-title" style="color: var(--uc-azul-oscuro); font-size: 1.1rem; margin-bottom: 5px;">Daniela Olivares</h4>
                  <p style="color: var(--uc-gris-oscuro); font-size: 0.85rem; line-height: 1.3;">Instituto de Investigaciones Agropecuarias</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-10 mb-4">
            <div class="single-team" style="border: 1px solid var(--uc-gris-claro); border-radius: 10px; overflow: hidden; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 25px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
              ...
              <div class="team-details" style="padding: 20px 15px;">
                <div class="team-inner text-center">
                  <h4 class="team-title" style="color: var(--uc-azul-oscuro); font-size: 1.1rem; margin-bottom: 5px;">Juan Pablo Zoffoli</h4>
                  <p style="color: var(--uc-gris-oscuro); font-size: 0.85rem; line-height: 1.3;">Pontificia Universidad Católica de Chile</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-10 mb-4">
            <div class="single-team" style="border: 1px solid var(--uc-gris-claro); border-radius: 10px; overflow: hidden; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 25px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
              ...
              <div class="team-details" style="padding: 20px 15px;">
                <div class="team-inner text-center">
                  <h4 class="team-title" style="color: var(--uc-azul-oscuro); font-size: 1.1rem; margin-bottom: 5px;">Edgard Álvarez</h4>
                  <p style="color: var(--uc-gris-oscuro); font-size: 0.85rem; line-height: 1.3;">Instituto de Investigaciones Agropecuarias</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-10 mb-4">
            <div class="single-team" style="border: 1px solid var(--uc-gris-claro); border-radius: 10px; overflow: hidden; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 25px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
              ...
              <div class="team-details" style="padding: 20px 15px;">
                <div class="team-inner text-center">
                  <h4 class="team-title" style="color: var(--uc-azul-oscuro); font-size: 1.1rem; margin-bottom: 5px;">Soledad Sánchez</h4>
                  <p style="color: var(--uc-gris-oscuro); font-size: 0.85rem; line-height: 1.3;">Instituto de Investigaciones Agropecuarias</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-10 mb-4">
            <div class="single-team" style="border: 1px solid var(--uc-gris-claro); border-radius: 10px; overflow: hidden; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 25px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
              ...
              <div class="team-details" style="padding: 20px 15px;">
                <div class="team-inner text-center">
                  <h4 class="team-title" style="color: var(--uc-azul-oscuro); font-size: 1.1rem; margin-bottom: 5px;">Cristina Vergara</h4>
                  <p style="color: var(--uc-gris-oscuro); font-size: 0.85rem; line-height: 1.3;">Instituto de Investigaciones Agropecuarias</p>
                </div>
              </div>
            </div>
    ...
    <div id="subscribe" class="section" style="background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%); padding: 80px 0;">
      <div class="container">
        <div class="section-header text-center mb-5">          
          <h2 class="section-title" style="color: var(--uc-azul-oscuro); font-size: 2.5rem; font-weight: 700; margin-bottom: 15px;">Auspiciadores</h2>
          ...
          <p class="section-subtitle" style="color: var(--uc-gris-oscuro); font-size: 1.1rem; line-height: 1.6; margin-bottom: 0; max-width: 800px; margin-left: auto; margin-right: auto;">Agradecemos el apoyo de nuestros valiosos auspiciadores que hacen posible las IX Jornadas de Postcosecha Chile 2025</p>
        </div>

        <!-- Auspiciadores Principales -->
        <div class="sponsors-section mb-5">
          <h4 class="text-center mb-4" style="color: var(--uc-azul-medio); font-weight: 600;">Auspiciadores Principales</h4>
          <div class="row justify-content-center align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div class="sponsor-item main-sponsor" style="background: white; padding: 30px; border-radius: 15px; box-shadow: 0 8px 25px rgba(0,0,0,0.1); text-align: center; transition: all 0.3s ease; height: 150px; display: flex; align-items: center; justify-content: center;" onmouseover="this.style.transform='translateY(-10px)'; this.style.boxShadow='0 15px 35px rgba(0,0,0,0.15)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 8px 25px rgba(0,0,0,0.1)'">
                <img src="https://picsum.photos/200/80?random=1&blur=0" alt="Frutas de Chile" style="max-width: 100%; max-height: 80px; object-fit: contain; border-radius: 8px;">
              </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div class="sponsor-item main-sponsor" style="background: white; padding: 30px; border-radius: 15px; box-shadow: 0 8px 25px rgba(0,0,0,0.1); text-align: center; transition: all 0.3s ease; height: 150px; display: flex; align-items: center; justify-content: center;" onmouseover="this.style.transform='translateY(-10px)'; this.style.boxShadow='0 15px 35px rgba(0,0,0,0.15)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 8px 25px rgba(0,0,0,0.1)'">
                <img src="https://picsum.photos/200/80?random=2&blur=0" alt="Fedefruta" style="max-width: 100%; max-height: 80px; object-fit: contain; border-radius: 8px;">
              </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div class="sponsor-item main-sponsor" style="background: white; padding: 30px; border-radius: 15px; box-shadow: 0 8px 25px rgba(0,0,0,0.1); text-align: center; transition: all 0.3s ease; height: 150px; display: flex; align-items: center; justify-content: center;" onmouseover="this.style.transform='translateY(-10px)'; this.style.boxShadow='0 15px 35px rgba(0,0,0,0.15)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 8px 25px rgba(0,0,0,0.1)'">
                <img src="https://picsum.photos/200/80?random=3&blur=0" alt="INIA - Instituto de Investigaciones Agropecuarias" style="max-width: 100%; max-height: 80px; object-fit: contain; border-radius: 8px;">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="sponsors-section">
          <h4 class="text-center mb-4" style="color: var(--uc-azul-medio); font-weight: 600;">Auspiciadores Colaboradores</h4>
          <div class="row justify-content-center align-items-center">
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4">
              <div class="sponsor-item" style="background: white; padding: 20px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); text-align: center; transition: all 0.3s ease; height: 120px; display: flex; align-items: center; justify-content: center;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 20px rgba(0,0,0,0.12)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(0,0,0,0.08)'">
                <img src="https://picsum.photos/150/60?random=4&blur=0" alt="ANID - Agencia Nacional de Investigación" style="max-width: 100%; max-height: 60px; object-fit: contain; border-radius: 6px;">
              </div>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4">
              <div class="sponsor-item" style="background: white; padding: 20px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); text-align: center; transition: all 0.3s ease; height: 120px; display: flex; align-items: center; justify-content: center;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 20px rgba(0,0,0,0.12)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(0,0,0,0.08)'">
                <img src="https://picsum.photos/150/60?random=5&blur=0" alt="ASOEX - Asociación de Exportadores de Chile" style="max-width: 100%; max-height: 60px; object-fit: contain; border-radius: 6px;">
              </div>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4">
              <div class="sponsor-item" style="background: white; padding: 20px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); text-align: center; transition: all 0.3s ease; height: 120px; display: flex; align-items: center; justify-content: center;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 20px rgba(0,0,0,0.12)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(0,0,0,0.08)'">
                <img src="https://picsum.photos/150/60?random=6&blur=0" alt="Fundación Chile" style="max-width: 100%; max-height: 60px; object-fit: contain; border-radius: 6px;">
              </div>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4">
              <div class="sponsor-item" style="background: white; padding: 20px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); text-align: center; transition: all 0.3s ease; height: 120px; display: flex; align-items: center; justify-content: center;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 20px rgba(0,0,0,0.12)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(0,0,0,0.08)'">
                <img src="https://picsum.photos/150/60?random=7&blur=0" alt="AgroTech Solutions" style="max-width: 100%; max-height: 60px; object-fit: contain; border-radius: 6px;">
              </div>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4">
              <div class="sponsor-item" style="background: white; padding: 20px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); text-align: center; transition: all 0.3s ease; height: 120px; display: flex; align-items: center; justify-content: center;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 20px rgba(0,0,0,0.12)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(0,0,0,0.08)'">
                <img src="https://picsum.photos/150/60?random=8&blur=0" alt="SAG - Servicio Agrícola y Ganadero" style="max-width: 100%; max-height: 60px; object-fit: contain; border-radius: 6px;">
              </div>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4">
              <div class="sponsor-item" style="background: white; padding: 20px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); text-align: center; transition: all 0.3s ease; height: 120px; display: flex; align-items: center; justify-content: center;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 20px rgba(0,0,0,0.12)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(0,0,0,0.08)'">
                <img src="https://picsum.photos/150/60?random=9&blur=0" alt="CORFO - Corporación de Fomento" style="max-width: 100%; max-height: 60px; object-fit: contain; border-radius: 6px;">
              </div>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-4">
              <div class="sponsor-item" style="background: white; padding: 20px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); text-align: center; transition: all 0.3s ease; height: 120px; display: flex; align-items: center; justify-content: center;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 20px rgba(0,0,0,0.12)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(0,0,0,0.08)'">
                <img src="https://picsum.photos/150/60?random=10&blur=0" alt="Fundación para el Desarrollo Frutícola" style="max-width: 100%; max-height: 60px; object-fit: contain; border-radius: 6px;">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="contact-form">
        <div class="container">
          <div class="section-header">          
            ...
            <span>Contacto</span>
            <p class="section-subtitle">¿Tienes preguntas sobre las IX Jornadas de Postcosecha? Contáctanos o completa el formulario de inscripción.</p>
          </div>
          <div class="row">          
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre *" required data-error="Por favor ingrese su nombre">
                        <div class="help-block with-errors"></div>
                      </div>                                 
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <input type="text" class="form-control" id="apellido_paterno" name="apellido_paterno" placeholder="Apellido Paterno *" required data-error="Por favor ingrese su apellido paterno">
                        <div class="help-block with-errors"></div>
                      </div> 
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <input type="text" class="form-control" id="apellido_materno" name="apellido_materno" placeholder="Apellido Materno *" required data-error="Por favor ingrese su apellido materno">
                        <div class="help-block with-errors"></div>
                      </div> 
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <input type="email" class="form-control" id="email" name="email" placeholder="Correo Electrónico *" required data-error="Por favor ingrese un email válido">
                        <div class="help-block with-errors"></div>
                      </div> 
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <input type="tel" class="form-control" id="telefono" name="telefono" placeholder="Teléfono *" required data-error="Por favor ingrese su teléfono">
                        <div class="help-block with-errors"></div>
                      </div> 
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <input type="text" class="form-control" id="institucion" name="institucion" placeholder="Institución/Empresa *" required data-error="Por favor ingrese su institución o empresa">
                        <div class="help-block with-errors"></div>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <select class="form-control" id="asunto" name="asunto" required data-error="Por favor seleccione un asunto">
                    ...
                    <div class="col-md-12">
                      <div class="form-group"> 
                        <textarea class="form-control" id="mensaje" name="mensaje" placeholder="Mensaje adicional" rows="5" data-error="Por favor escriba su mensaje"></textarea>
                        <div class="help-block with-errors"></div>
                      </div>
        ...
        <div class="container">
          ...
          <div class="row mb-5">
            <div class="col-lg-10 mx-auto">
              <div class="venue-info venue-bounce" style="background: white; padding: 40px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); border-left: 6px solid var(--uc-celeste); animation: bounceIn 1.2s ease-out; transition: all 0.3s ease;" onmouseover="this.style.transform='scale(1.02)'; this.style.boxShadow='0 15px 40px rgba(0,0,0,0.15)'" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 10px 30px rgba(0,0,0,0.1)'">
                <div class="row">
                  <div class="col-md-8">
    ...
    <footer class="uc-footer" style="background-color: var(--uc-azul-oscuro); padding: 60px 0 0;">
      <div class="container pb-48">
        <div class="row">
          ...
          <div class="col-lg-8 offset-lg-1">
            <div class="h2 text-font--serif mt-28" style="color: white; font-family: serif; font-size: 2.5rem; font-weight: 300; margin-bottom: 30px;">
            ...
            <ul class="uc-footer_social" style="list-style: none; padding: 0; display: flex; gap: 15px; margin: 0;">
              <li>
                <a href="#" style="display: inline-block; transition: opacity 0.3s;" onmouseover="this.style.opacity='0.7'" onmouseout="this.style.opacity='1'">
                  <img
      ...
      <div id="uc-global-footer" style="background-color: var(--uc-azul-oscuro); border-top: 1px solid rgba(255,255,255,0.1); padding: 20px 0; text-align: center; color: #ccc; font-size: 14px;">
        <div class="container">
